module.exports = {
    ...
    "containerDefinitions": [
        {
            "name": "personsdetails-1690",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-demoapp-1690-personsdetails:latest`,
